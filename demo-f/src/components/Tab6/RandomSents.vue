...
<div class="row">
    <div class="col-12">
        <p>
           <button type="button" class="btn btn-secondary me-md-2" @click.prevent="getRandomSentence()">Get New Sentence</button> 
           <button type="button" class="btn btn-secondary" @click.prevent="swapContext()">Swap Context</button>
        </p>
    </div>
</div>
<div class="row">
        ...
        <div class="row">
            <div class="col-12">
                <div v-if="displaydata != null" class="card">
                    <div class="card-body">
                        <p v-html="highlight(displaydata.sentences[0], target_word)"></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-6">
        ...
        <div class="row">
            <div class="col-12">
                <div v-if="displaydata != null" v-for="s in displaydata.sentences[1]" class="card mb-1 align-middle">
                    <div class="card-body">
